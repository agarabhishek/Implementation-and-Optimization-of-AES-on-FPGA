...
#define XAES_FULL_CRTLS_ADDR_NR_DATA                  0x200
...
#define XAES_FULL_CRTLS_ADDR_DATA_OUT_BASE            0x210
#define XAES_FULL_CRTLS_ADDR_DATA_OUT_HIGH            0x21f
