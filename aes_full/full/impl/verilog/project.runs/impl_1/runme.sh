...
HD_PWD='D:/Dr.R.N.Biswas_Project_Files/Major_Project1/project/New/AES_HLS/aes_full/full/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Encrypt.vdi -applog -m64 -messageDb vivado.pb -mode batch -source AES_Encrypt.tcl -notrace
