...
HD_PWD='D:/Dr.R.N.Biswas_Project_Files/Major_Project1/project/New/AES_HLS/aes_full/full/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Encrypt.vds -m64 -mode batch -messageDb vivado.pb -notrace -source AES_Encrypt.tcl
