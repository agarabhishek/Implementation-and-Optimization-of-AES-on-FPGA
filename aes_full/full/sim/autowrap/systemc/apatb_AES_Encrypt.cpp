...
#define AES_Encrypt AESL_ORIG_DUT_AES_Encrypt
...
unsigned char ciphertext[16])
{
	...
	else
	{
		...
		sc_bv<8>* expandedKey_tvin_wrapc_buffer = new sc_bv<8>[176];
...
// [call_c_dut] ---------->
		...
		AESL_ORIG_DUT_AES_Encrypt(plaintext, expandedKey, Nr, ciphertext);
