...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.AES_Encrypt.autotvin_plaintext.dat"
         "c.AES_Encrypt.autotvin_expandedKey.dat"
         "c.AES_Encrypt.autotvout_ciphertext.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.AES_Encrypt.autotvout_ciphertext.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
