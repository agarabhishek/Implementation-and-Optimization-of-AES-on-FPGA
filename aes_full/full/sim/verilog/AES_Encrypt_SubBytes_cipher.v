...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module AES_Encrypt_SubBytes_cipher_rom (
...
initial begin
    $readmemh("./AES_Encrypt_SubBytes_cipher_rom.dat", ram0);
    $readmemh("./AES_Encrypt_SubBytes_cipher_rom.dat", ram1);
    $readmemh("./AES_Encrypt_SubBytes_cipher_rom.dat", ram2);
    $readmemh("./AES_Encrypt_SubBytes_cipher_rom.dat", ram3);
    $readmemh("./AES_Encrypt_SubBytes_cipher_rom.dat", ram4);
    $readmemh("./AES_Encrypt_SubBytes_cipher_rom.dat", ram5);
    $readmemh("./AES_Encrypt_SubBytes_cipher_rom.dat", ram6);
    $readmemh("./AES_Encrypt_SubBytes_cipher_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module AES_Encrypt_SubBytes_cipher(
    reset,
    clk,
    address0,
    ce0,
...
AES_Encrypt_SubBytes_cipher_rom AES_Encrypt_SubBytes_cipher_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
