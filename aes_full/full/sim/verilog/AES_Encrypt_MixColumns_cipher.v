...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module AES_Encrypt_MixColumns_cipher_rom (
...
initial begin
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram0);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram1);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram2);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram3);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram4);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram5);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram6);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram7);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram8);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram9);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram10);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram11);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram12);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram13);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram14);
    $readmemh("./AES_Encrypt_MixColumns_cipher_rom.dat", ram15);
end
...
`timescale 1 ns / 1 ps
module AES_Encrypt_MixColumns_cipher(
    reset,
    clk,
    address0,
    ce0,
...
AES_Encrypt_MixColumns_cipher_rom AES_Encrypt_MixColumns_cipher_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
