set moduleName AES_Encrypt_MixColumns
...
set isOneStateSeq 0
set C_modelName {AES_Encrypt_MixColumns}
set C_modelType { void 0 }
set C_modelArgList {
	{ state int 8 regular {array 16 { 2 1 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"], "CDFG" : "AES_Encrypt_MixColumns", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
	...
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_state_U", "Parent" : "0", "Child" : []}]}
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 4 }  { state_ce0 mem_ce 1 1 }  { state_we0 mem_we 1 1 }  { state_d0 mem_din 1 8 }  { state_q0 mem_dout 0 8 }  { state_address1 mem_address 1 4 }  { state_ce1 mem_ce 1 1 }  { state_q1 mem_dout 0 8 } } }
}
